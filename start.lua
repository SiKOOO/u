...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "كندا"),data="delnamebot"}},
...
name = string.gsub(name,"هادئ","كنداي")
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "كندا"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "كندا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "كندا"),(redis:get(bot_id..":namebot") or "كندا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == "اكلك" or text == (redis:get(bot_id..":namebot") or "كندا") then
